<?php
/**
 * Title: Degree Of Perfection
 * Slug: celsius-cooking-fse/degree-of-perfection
...
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.5"}}} -->
<h3 class="wp-block-heading" style="line-height:1.5"><strong>Why precision makes the differences</strong></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
<p style="font-size:18px">Overcooking can really affect the nutritional value of the food you cook, whereas over-boiling vegetables robs them of their vitamins. Both undercooked and overcooked meat can pose health risks. When cooking, there is often also a risk of burnt and potentially harmful food particles entering the air. So, even if you cook yourself, without turning to recipes, Celsius°Cooking™ accessories will help you avoid cooking food at the wrong temperature.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.5"}}} -->
<h3 class="wp-block-heading" style="line-height:1.5"><strong>The heart of Celsius°Cooking™. Sensors and intelligence.</strong></h3>
<!-- /wp:heading -->
