...
/**
 * Title: Warranty
 * Slug: celsius-cooking-fse/warranty
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/main-banner.jpg","id":820,"dimRatio":0,"minHeight":500,"style":{"color":{}}} -->
...
<p style="font-size:15px">HERE YOU CAN FIND WARRANTY INFORMATION ABOUT YOUR CELSIUS COOKING COOKWARE</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><strong>Warranty</strong></h2>
<!-- /wp:heading -->
...
<p style="font-size:18px">Warranty pan</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
<p style="font-size:18px">Warranty probe</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
<p style="font-size:18px">If you need additional help and need to get in contact with support, please visit your brand's local website.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
